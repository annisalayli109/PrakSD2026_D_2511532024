...
public class QueueArray_2511532024 {
	...
	boolean isFull_2024(QueueArray_2511532024 queue) {
		return (queue.size_2024 == queue.capacity_2024);
	}
	
	boolean isEmpty_2024(QueueArray_2511532024 queue) {
		return (queue.size_2024 == 0);
	}
	
	void enqueue_2024 (int item) {
		if (isFull_2024(this))
			return;
	...
	void display_2024() {
		...
		for (i_2024 = front_2024; i_2024 < rear_2024; i_2024++) {
			System.out.printf(" %d <-- ", array_2024[i_2024]);
		}
		return;
	}
}
